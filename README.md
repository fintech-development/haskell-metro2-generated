## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `METRO2 API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the METRO2 API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | METRO2                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | metro2                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | METRO2Config                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | TheMetro2Request                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| METRO2.Client    | use the "dispatch" functions to send requests       |
| METRO2.Core      | core functions, config and request types            |
| METRO2.API       | construct api requests                              |
| METRO2.Model     | describes api models                                |
| METRO2.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| METRO2.ModelLens | lenses for model fields                             |
| METRO2.Logging   | logging functions and utils                         |
