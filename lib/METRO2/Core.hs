...
module METRO2.Core where

import METRO2.MimeTypes
import METRO2.Logging
...
-- |
data METRO2Config = METRO2Config
...
-- | display the config
instance P.Show METRO2Config where
  show c =
    T.printf
...
-- | constructs a default METRO2Config
--
-- configHost:
--
-- @http://localhost:8080@
...
-- @"metro2/0.1.0.0"@
--
newConfig :: IO METRO2Config
newConfig = do
    logCxt <- initLogContext
    return $ METRO2Config
        { configHost = "http://localhost:8080"
        , configUserAgent = "metro2/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => METRO2Config -> auth -> METRO2Config
addAuthMethod config@METRO2Config {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: METRO2Config -> IO METRO2Config
...
withStderrLogging :: METRO2Config -> IO METRO2Config
...
withNoLogging :: METRO2Config -> METRO2Config
...
data TheMetro2Request req contentType res accept = TheMetro2Request
  { rMethod  :: NH.Method   -- ^ Method of TheMetro2Request
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of TheMetro2Request
  , rParams   :: Params -- ^ params of TheMetro2Request
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (TheMetro2Request req contentType res accept) NH.Method
rMethodL f TheMetro2Request{..} = (\rMethod -> TheMetro2Request { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (TheMetro2Request req contentType res accept) [BCL.ByteString]
rUrlPathL f TheMetro2Request{..} = (\rUrlPath -> TheMetro2Request { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (TheMetro2Request req contentType res accept) Params
rParamsL f TheMetro2Request{..} = (\rParams -> TheMetro2Request { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (TheMetro2Request req contentType res accept) [P.TypeRep]
rAuthTypesL f TheMetro2Request{..} = (\rAuthTypes -> TheMetro2Request { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => TheMetro2Request req contentType res accept -> param -> TheMetro2Request req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: TheMetro2Request req contentType res accept -> param -> TheMetro2Request req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: TheMetro2Request req contentType res accept -> param -> TheMetro2Request req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** TheMetro2Request Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> TheMetro2Request req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = TheMetro2Request m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     TheMetro2Request req contentType res accept
  -> [NH.Header]
  -> TheMetro2Request req contentType res accept
...
removeHeader :: TheMetro2Request req contentType res accept -> [NH.HeaderName] -> TheMetro2Request req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => TheMetro2Request req contentType res accept -> TheMetro2Request req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => TheMetro2Request req contentType res accept -> TheMetro2Request req contentType res accept
...
addForm :: TheMetro2Request req contentType res accept -> WH.Form -> TheMetro2Request req contentType res accept
addForm req newform =
...
_addMultiFormPart :: TheMetro2Request req contentType res accept -> NH.Part -> TheMetro2Request req contentType res accept
...
_setBodyBS :: TheMetro2Request req contentType res accept -> B.ByteString -> TheMetro2Request req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: TheMetro2Request req contentType res accept -> BL.ByteString -> TheMetro2Request req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => TheMetro2Request req contentType res accept -> P.Proxy authMethod -> TheMetro2Request req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> TheMetro2Request req contentType res accept
    -> IO (TheMetro2Request req contentType res accept)
...
_applyAuthMethods
  ...
  -> METRO2Config
  -> IO (TheMetro2Request req contentType res accept)
_applyAuthMethods req config@(METRO2Config {configAuthMethods = as}) =
  foldlM go req as
  where
